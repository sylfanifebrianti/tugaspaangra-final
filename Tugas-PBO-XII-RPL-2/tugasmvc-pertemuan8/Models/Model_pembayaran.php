...
class Model_pembayaran{
    ...
    function POST ($id_pembayaran, $id_petugas, $nisn, $tgl_bayar, $bulan_dibayar, $tahun_bayar, $id_spp, $jumlah_bayar){
        ...
        mysqli_query($this->con , "INSERT INTO pembayaran (id_pembayaran, id_petugas, nisn, tgl_bayar, bulan_dibayar, tahun_bayar, id_spp, jumlah_bayar) VALUES (NULL, '1061209', '1234567891', '22', '12', '2020', '1', '3500')");
        
        // mysqli_query($this->con,"INSERT INTO pembayaran (id_pembayaran, id_petugas, nisn, tgl_bayar, bulan_dibayar, tahun_bayar, id_spp, jumlah_bayar) VALUES(
        //     NULL,
        //     '".$id_petugas."',
        //     '".$nisn."',
        //     '".$tgl_bayar."',
